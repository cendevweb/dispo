<template>
  <div class="mt-1 relative ml-20">
    <label id="listbox-label" class="block text-sm font-medium text-white">
        Category :
    </label>
    <button type="button" aria-haspopup="listbox" aria-expanded="true" aria-labelledby="listbox-label" class="relative w-96 bg-white border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
    ...
    <!--
      ...
      Leaving: "transition ease-in duration-100"
        ...
        To: "opacity-0"
    -->
    <div class="absolute mt-1 w-96 rounded-md bg-white shadow-lg">
      <ul tabindex="-1" role="listbox" aria-labelledby="listbox-label" aria-activedescendant="listbox-item-3" class="max-h-56 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
        ...
        <li id="listbox-item-0" role="option" class="text-gray-900 cursor-default select-none relative py-2 pl-3 pr-9">
          <div class="flex items-center">
            <img :src="'src/assets/lol_thumbnail.jpg'" alt="" class="flex-shrink-0 h-6 w-6 rounded-full">
        ...
        <li id="listbox-item-1" role="option" class="text-gray-900 cursor-default select-none relative py-2 pl-3 pr-9">
          <div class="flex items-center">
            <img :src="'src/assets/chess_thumbnail.jpeg'" alt="" class="flex-shrink-0 h-6 w-6 rounded-full"/>
            <!-- Selected: "font-semibold", Not Selected: "font-normal" -->
            <span class="ml-3 block font-normal truncate">
              Chess
            </span>
        ...
        <li id="listbox-item-2" role="option" class="text-gray-900 cursor-default select-none relative py-2 pl-3 pr-9">
          <div class="flex items-center">
            <img :src="'src/assets/rl_thumbnail.jpg'" alt="" class="flex-shrink-0 h-6 w-6 rounded-full">
            <!-- Selected: "font-semibold", Not Selected: "font-normal" -->
            <span class="ml-3 block font-normal truncate">
              Rocket League
            </span>
